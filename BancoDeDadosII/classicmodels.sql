...
-- Copiando estrutura para tabela classicmodels.customers
...
-- Copiando dados para a tabela classicmodels.customers: ~122 rows (aproximadamente)
...
-- Copiando estrutura para tabela classicmodels.employees
...
-- Copiando dados para a tabela classicmodels.employees: ~23 rows (aproximadamente)
INSERT IGNORE INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
...
-- Copiando estrutura para tabela classicmodels.offices
...
-- Copiando dados para a tabela classicmodels.offices: ~7 rows (aproximadamente)
INSERT IGNORE INTO `offices` (`officeCode`, `city`, `phone`, `addressLine1`, `addressLine2`, `state`, `country`, `postalCode`, `territory`) VALUES
...
-- Copiando estrutura para tabela classicmodels.orderdetails
...
-- Copiando dados para a tabela classicmodels.orderdetails: ~2.996 rows (aproximadamente)
INSERT IGNORE INTO `orderdetails` (`orderNumber`, `productCode`, `quantityOrdered`, `priceEach`, `orderLineNumber`) VALUES
	...
	(10426, 'S18_1749', 30, 136.00, 1),
	(10426, 'S18_2248', 50, 55.09, 2);

-- Copiando estrutura para tabela classicmodels.orders
...
-- Copiando dados para a tabela classicmodels.orders: ~326 rows (aproximadamente)
INSERT IGNORE INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`) VALUES
	...
	(10426, '2005-05-31', '2005-06-10', '2005-06-11', 'In Process', NULL, 145),
	(10430, '2022-05-31', '2022-06-10', '2022-06-11', 'Testando', NULL, 103);

-- Copiando estrutura para tabela classicmodels.payments
...
-- Copiando dados para a tabela classicmodels.payments: ~273 rows (aproximadamente)
INSERT IGNORE INTO `payments` (`customerNumber`, `checkNumber`, `paymentDate`, `amount`) VALUES
...
-- Copiando estrutura para tabela classicmodels.productlines
...
-- Copiando dados para a tabela classicmodels.productlines: ~7 rows (aproximadamente)
INSERT IGNORE INTO `productlines` (`productLine`, `textDescription`, `htmlDescription`, `image`) VALUES
...
-- Copiando estrutura para tabela classicmodels.products
...
-- Copiando dados para a tabela classicmodels.products: ~110 rows (aproximadamente)
